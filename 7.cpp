...
public:
    ...
    void pop_back() {
        if (size > 0) {
            ...
            throw out_of_range("Vect is empty");
        }
    }
    ...
    private:
        ...
        size_t index;
    public:
        PositiveIterator(Vect<T>& v) : vect(v), index(0) {
        ...
        T& next() {
            if (!hasNext()) {
                throw CustomException("No more positive elements", 0, 1);
            }
    ...
    private:
        ...
        size_t index;
    public:
        NegativeIterator(Vect<T>& v) : vect(v), index(0) {
            while (index < vect.size && vect.data[index] >= 0) {
                index++;
            }
        }
        ...
        T& next() {
            if (!hasNext()) {
                throw CustomException("No more negative elements", 0, 1);
            }
            T& value = vect.data[index];
            do {
                index++;
...
public:
    ...
    typename Vect<T>::PositiveIterator positiveIterator() {
        return typename Vect<T>::PositiveIterator(*vect);
    }

    typename Vect<T>::NegativeIterator negativeIterator() {
        return typename Vect<T>::NegativeIterator(*vect);
    }
};
...
int main() {
    ...
    while (true) {
        ...
        cout << "4. Показать положительные элементы\n";
        cout << "5. Показать отрицательные элементы\n";
        cout << "6. Выйти\n";
